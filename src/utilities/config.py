...
BIGQUERY_DESTINATION_CONFIG = {
    ...
    "DESTINATION__BIGQUERY__CREDENTIALS__PROJECT_ID": os.environ.get(
        "DESTINATION_PROJECT_ID"
    ),
    "DESTINATION__BIGQUERY__CREDENTIALS__PRIVATE_KEY": os.environ.get(
        "DESTINATION_PRIVATE_KEY"
    ),
    "DESTINATION__BIGQUERY__CREDENTIALS__CLIENT_EMAIL": os.environ.get(
        "DESTINATION_CLIENT_EMAIL"
    ),
}


SQL_SOURCE_CONFIG = {
    "SOURCES__SQL_DATABASE__CREDENTIALS__DRIVERNAME": os.environ.get(
        "SOURCE_DRIVERNAME"
    ),
    ...
    "SOURCES__SQL_DATABASE__SSL": os.environ.get("SOURCE_SSL", "false").lower()
    == "true",
